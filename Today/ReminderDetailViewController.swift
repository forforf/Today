...
class ReminderDetailViewController: UITableViewController {
    ...
    // configure can inject depedndencies
    ...
    // Tutorial says to use this to remove the Toolbar with the Add option from the
    // detail view screen. But even without this, the Toolbar wasn't appearing in the
    // detail view screen
    ...
    // ToDo: Although this is how the tutorial set it up, I really don't like all the nested  if/else. Refactor to something more sane.
